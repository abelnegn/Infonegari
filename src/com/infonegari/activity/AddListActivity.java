...
public class AddListActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		sp_location = (Spinner) findViewById(R.id.location);
		txtTitle = (EditText) findViewById(R.id.title);
		txtDiscription = (EditText) findViewById(R.id.discription);
		btnChoosePic = (Button) findViewById(R.id.choose_photo);
		...
		String category = getIntent().getExtras().getString("Add_Category");
		this.setTitle("Add " + category);

		fetchLocation();
		
		Button picBtn = (Button) findViewById(R.id.take_photo);
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        mItemSearchClient.setIcon(new IconDrawable(this, Iconify.IconValue.fa_backward)
