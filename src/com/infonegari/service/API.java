...
public class API {
    ...
    public static ClinicTypeService clinicTypeService;
    ...
    private static synchronized void init() {
    	...
    	clinicTypeService = sRestAdapter.create(ClinicTypeService.class);
	...
	public interface ClinicTypeService{
        @Headers({ACCEPT_JSON, CONTENT_TYPE_JSON})
        @GET(APIEndPoint.CLINIC_TYPE)
        public void getClinicTypes(@Query("type_id") long typeId, 
        		Callback<List<ClinicType>> callback);
    }
